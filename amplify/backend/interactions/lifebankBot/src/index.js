...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        
        {
            ...
            "fulfillmentLambda": {
                ...
                "accountId": "088711593565",
                "lambdaArn": "arn:aws:lambda:ap-southeast-2:088711593565:function:lifebankIntentHandler-dev",
                "lambdaName": "lifebankIntentHandler-dev",
            },
            "fulfillmentActivity": {
                "type": "CodeHook",
                "codeHook": {
                    "messageVersion": "1.0",
                    "uri": "arn:aws:lambda:ap-southeast-2:088711593565:function:lifebankIntentHandler-dev"
                }
            }, 
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "answerQuestionnaire",
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "1417f0b8",
